...
![chat with scott about http vs https error](https://raw.githubusercontent.com/carylwyatt/carylwyatt.github.io/blob/master/img/ssl.png)
...
Thanks to a very helpful stack overflow, it turns out I didn't know that http is served in port 80 but https in served in port 443. Changed that in my 000-default.conf, Dockerfile, and docker-compose and TADA! **IT'S LOADING AND SO IS THE MANAGEMENT APP!!** :tada::tada::sob::grin:
